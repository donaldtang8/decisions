...
const Search = ({ getResultsByFilters, resetCategories, getCategories, categories: { categories }, results: { results } }) => {
...
export default connect(mapStateToProps, { getResultsByFilters, resetCategories, getCategories })(Search);